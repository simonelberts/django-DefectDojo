...
from dojo.utils import add_comment, add_epic, add_issue, update_trello_issue, update_epic, update_issue, \
...
def update_trello_issue_task(new_finding, tconf):
    update_trello_issue(new_finding, tconf)
